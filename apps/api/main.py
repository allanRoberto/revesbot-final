...
from api.routes.terminal_signals import router as terminal_signals_router
...
from api.routes.quintet_shuffled_signals import router as quintet_shuffled_signals_router
...
from api.routes.probability_backtest import router as probability_backtest_router
...
app.include_router(terminal_signals_router)
...
app.include_router(quintet_shuffled_signals_router)
...
app.include_router(probability_backtest_router)
