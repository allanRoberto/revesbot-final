...
router = APIRouter()
signals_coll = mongo_db["terminal_7_signal_signals"]
...
@router.get("/api/terminal-7-signal-signals")
async def list_signals(
    ...
    distribution_attempts: Dict[int, int] = {1: 0, 2: 0}
...
@router.get("/api/terminal-7-signal-signals/{signal_id}")
