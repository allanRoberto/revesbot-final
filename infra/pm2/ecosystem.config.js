...
module.exports = {
  apps: [
    ...
    {
      name: `triplet-terminal-1pos-${suffix}`,
      cwd: repoRoot,
      ...
      env: {
        ...
        TRIPLET_TERMINAL_BLOCKED_TERMINALS: "0,7",
        TRIPLET_TERMINAL_ALLOWED_SCORES: "3,4,7",
        TRIPLET_TERMINAL_REQUIRE_INVERSION: "true",
      },
    },
    {
